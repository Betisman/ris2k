...
if (!jmaki.widgets.dhtmlgoodies) {
	jmaki.widgets.dhtmlgoodies = {};
}
jmaki.widgets.dhtmlgoodies.tooltip = {};

jmaki.widgets.dhtmlgoodies.tooltip.Widget = function(wargs) {
    ...
    function loadContent(divId, url) {
            jmaki.doAjax({asynchronous: false, url: url, callback: function(req) { 
